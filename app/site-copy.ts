...
export const copy = {
  uk: {
    ...
    audiences: [
      ["Для дорослих, які починають", "Щоб вода перестала бути напругою, а техніка стала зрозумілою."],
    ...
    guidedText:
      "Кожне наступне рішення спирається на те, що ви зробили й побачили у воді, а не на універсальний шаблон.",
    ...
    loopText:
      "Ми збираємо робочий тиждень навколо вашої цілі, доступу до басейну та часу на відновлення. Потім коригуємо його за фактом.",
  ...
  en: {
    ...
    loopText:
      "We build a working week around your goal, pool access and recovery time. Then we adjust it based on what actually happens.",
