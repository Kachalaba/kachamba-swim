...
- [x] **Step 1: Replace the obsolete Ukrainian dollar assertions with the approved UAH contract**
...
- [x] **Step 2: Add semantic and safety assertions for Happy Tri Friends**
...
- [x] **Step 3: Add a source-level locale contract for the English prices**
...
- [x] **Step 4: Run the focused test and confirm the new assertions fail for the intended reason**
...
- [x] **Step 1: Add one shared external destination**
...
- [x] **Step 2: Replace the Ukrainian price values and add localized clarification**
...
- [x] **Step 3: Split the coach biography around the semantic club link**
...
- [x] **Step 4: Render desktop and mobile hero affiliations with safe external-link semantics**
...
- [x] **Step 5: Render the contextual inline biography link and pricing clarification**
...
- [x] **Step 6: Rebuild and make the render contract green**
...
- [x] **Step 7: Commit the copy and semantic markup**
...
- [x] **Step 1: Define a restrained club-gold accent**
...
- [x] **Step 2: Style the desktop documentary affiliation**
...
- [x] **Step 3: Style the coach biography link as editorial context**
...
- [x] **Step 4: Place the mobile affiliation between facts and CTA**
...
- [x] **Step 6: Extend browser QA for both locales, responsive placement, and external-link safety**
...
- [x] **Step 7: Run browser QA against the production build**
...
- [x] **Step 8: Commit the visual treatment and QA**
...
- [x] **Step 1: Preserve the diagnostic failure as the baseline**
...
- [x] **Step 2: Fix feature detection without impossible type narrowing**
...
- [x] **Step 3: Capture a non-null hero element for every callback closure**
...
- [x] **Step 4: Isolate the Next.js application type-check from Cloudflare worker modules**
...
- [x] **Step 5: Verify both strict app types and the native production build**
...
- [x] **Step 6: Re-run the Sites/vinext build to prove target isolation**
...
- [x] **Step 7: Commit the cross-target type fixes**
...
- [x] **Step 1: Add an explicit Vercel build script without changing the Sites build**
...
- [x] **Step 2: Override only Vercel’s build command**
...
- [x] **Step 3: Reproduce the Vercel-facing command locally**
...
- [x] **Step 5: Commit the deployment target**
...
- [x] **Step 2: Run production browser QA at all required viewports**
...
- [x] **Step 3: Inspect final screenshots**
